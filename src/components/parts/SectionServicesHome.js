...
export default function SectionServicesHome() {
  return (
    <div className='my-10'>
        ...
        <div className=' grid justify-center grid-cols-2 flex-wrap gap-20 m-10 mx-72'>
           {CardServiceData.map((item) => (
					<div key={item.id} className='bg-gradient-to-r from-purple-800 to-purple-900 text-white p-6 rounded-3xl w-full h-72'>
